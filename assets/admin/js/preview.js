...
PreviewView = (function(_super) {
  ...
  PreviewView.prototype.id = 'mbg-preview';

  PreviewView.prototype.initialize = function() {
    return $.post('admin-ajax.php?action=mbg-preview', {
      data: $('#post').serialize()
    }, (function(_this) {
      return function(response) {
        _this.$el.html(response);
        return _this.data = _this.$('.mbg').data('mb-gallery');
      };
    })(this));
  };
  ...
  PreviewView.prototype.render = function() {
    ...
    return this.$el.append($('<div class="mbg-spinner-large"></div>').show());
  };
