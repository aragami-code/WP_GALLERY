...
(function() {
  ...
  jQuery(function() {
    ...
    ManualEditor = (function(_super) {
      ...
      ImageEditor = (function() {
        function ImageEditor(view) {
          ...
          this.$lightboxTitle = this.$view.find('input.mbg-lightbox-title');
          this.$lightboxDescription = this.$view.find('textarea.mbg-lightbox-description');
          ...
          this.mainImageSelector = new mbg.ImageSelector({
            el: this.$view.find('.mbg-manual-main-image')
          });
          ...
          this.lightboxImageSelector = new mbg.ImageSelector({
            el: this.$view.find('.mbg-manual-lightbox-image')
          });
    ...
    }).call(this, window.mbgSourceEditor);
    return window.mbgRegisteredSourceEditors.manual = ManualEditor;
  });
